$.widget("forecast.fabPo", {
    ...
    _create: function () {
        console.log("SMNLOG :: ---------- fabPo widget create ----------");
        ...
        console.log(self.data.addressTypeMap)
    ...
    _init: function () {
        console.log("SMNLOG :: ---------- fabPo widget init ----------");
        var options = this.options;
        var self = this;
    ...
    initiateFormValidation: function () {
        ...
        self.el.fabPoForm.validate(validateJson);
...
/*        self.el.poType.on('change', function () {
        ...
        self.el.submitButton.on('click', function(){
            self.el.fabPoForm.trigger('submit');
        });
    },
    addAddressInformationRow: function (idx, addressItem, labelName, isVendor, isShipTo  ) {
        ...
        var $rowToAppend = '<div class="col-md-4">'
            ...
            + '<label class="col-md-3 col-form-label asterisk"> '+ labelName+ ' </label>'
    ...
    addLineItemForProduct: function (isPlusIcon, productItem) {
        ...
        var $rowToAppend = '<div class="row product-dynamic-row lineItemBorder" attr-secretCode="'+secretCode+'">'
            ...
            + '<input name="productItemList[' + index + '].wipReconciliationStarted" class="wipReconciliationStarted" style="display: none;" value=false />'
    ...
    disableForViewOnly: function(){
        var self = this;
        self.el.fabPoForm.find('input[type!="hidden"]').attr("disabled", true);
        self.el.fabPoForm.find('select').attr("disabled", true);
        self.el.fabPoForm.find('textarea').attr("disabled", true);
        self.el.fabPoForm.find('.itemAddButtonFlat').hide();
        self.el.fabPoForm.find('.itemRemoveButtonFlat').hide();
        self.el.fabPoForm.find('#shipViaAdd').hide();
        self.el.fabPoForm.find('a[type="button"]').not("#submitButton").hide();
        self.el.submitButton.parent().html(self.el.gobackButton);
        self.el.fabPoForm.attr("href", "#");
    },
    destroy: function () {
    }
});
