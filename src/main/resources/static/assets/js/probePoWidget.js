$.widget("forecast.probePo", {
    ...
    _create: function () {
        console.log("SMNLOG :: ---------- probePo widget create ----------");
        ...
        self.el.probePoForm = $("#probe_po_form");
        ...
        self.el.gobackButton = '<a href="/admin/probePOList" type="button" class="btn btn-primary float-right" ><i class="fa fa-arrow-left"></i>&nbsp;' + self.options.messages.goBack + '</a>';
    ...
    _init: function () {
        console.log("SMNLOG :: ---------- probePo widget init ----------");
        var options = this.options;
        var self = this;
    ...
    initiateFormValidation: function () {
        ...
        self.el.probePoForm.validate(validateJson);
    ...
    uiEventInitialization: function () {
        ...
        self.el.submitButton.on('click', function(){
            self.el.probePoForm.trigger('submit');
        });
    },
    ...
    disableForViewOnly: function(){
        ...
        self.el.probePoForm.find('input[type!="hidden"]').attr("disabled", true);
        self.el.probePoForm.find('select').attr("disabled", true);
        self.el.probePoForm.find('textarea').attr("disabled", true);
        self.el.searchBoxReviewer.attr("disabled", true);
        self.el.probePoForm.find('a[type="button"]').not("#submitButton").hide();
        self.el.probePoForm.find('button[type="button"]').not(".next-button").hide();
        self.el.submitButton.parent().html(self.el.gobackButton);
        self.el.probePoForm.attr("href", "#");
    },
    destroy: function () {
    }
});
