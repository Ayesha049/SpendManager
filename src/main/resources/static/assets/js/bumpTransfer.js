$.widget("forecast.bumpTransfer", {
    options: {
        messages: undefined
    },
    _create: function () {
        console.log("SMNLOG :: ---------- BUMP Transfer widget create ----------");
        var self = this;
        self.el = {};
        self.data = {};

        // UI element Initialization
        self.el.bumpTransferForm = $("#transferForm");
        ...
        self.el.workOrderSelect.change(function () {
            ...
            console.log("select bumpWorkOrderId :::: " + bumpWorkOrderId);
            self.makeWipTransferDetailsTable(bumpWorkOrderId);
        });
    ...
    _init: function () {
        console.log("SMNLOG :: ---------- BUMP WIP Transfer init ----------");
        var self = this;

    },
    makeWipTransferDetailsTable: function (bumpWorkOrderId) {
        var self = this;
        var listSize = 0;
        ...
        if (bumpWorkOrderId > 0) {
            ...
            $.get('/admin/getBumpWipInventoryForTransfer', {bumpWorkOrderId: bumpWorkOrderId}, function (list) {
                ...
                self.generateTransferStatusTable(bumpWorkOrderId, listSize);
    ...
    generateTransferStatusTable: function(bumpWorkOrderId, transferTableDetailsSize){
        var self=this;
        var html = '<table class="table table-striped custom-table">';
        html += '<thead>';
        ...
        $.get('/admin/getBumpWipInventoryStatusForTransfer', {bumpWorkOrderId: bumpWorkOrderId}, function (list) {
    ...
    changeStatusTransferProductItemBtnEvent: function(trObject, status){
        ...
        var validator = self.el.bumpTransferForm.validate();
        var errorMessage = "";
    ...
    recordStatusChange:function(trObject, productItemId, productTransferItemId, status, transferredQuantity, wasteQuantity){
        ...
        $.get('/admin/transferBumpServiceChangeProductTransferItemStatus',
            {
            ...
            function(response){
                ...
                self.el.bumpTransferForm.validate();
    ...
    initiateFormValidation: function (transferTableDetailsSize, transferStatusTableSize) {
        ...
        self.el.bumpTransferForm.validate(validateJson);
    },
