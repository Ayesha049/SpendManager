$.widget("forecast.testPo", {
    ...
    _create: function () {
        console.log("SMNLOG :: ---------- testPo widget create ----------");
        ...
        self.el.testPoForm = $("#test_po_form");
        ...
        self.el.gobackButton = '<a href="/admin/testPOList" type="button" class="btn btn-primary float-right" ><i class="fa fa-arrow-left"></i>&nbsp;' + self.options.messages.goBack + '</a>';
    ...
    _init: function () {
        console.log("SMNLOG :: ---------- testPo widget init ----------");
        var options = this.options;
        var self = this;
    ...
    initiateFormValidation: function () {
        ...
        self.el.testPoForm.validate(validateJson);
    ...
    uiEventInitialization: function () {
        ...
        self.el.submitButton.on('click', function(){
            self.el.testPoForm.trigger('submit');
        });
    },
    ...
    disableForViewOnly: function(){
        ...
        self.el.testPoForm.find('input[type!="hidden"]').attr("disabled", true);
        self.el.testPoForm.find('select').attr("disabled", true);
        self.el.testPoForm.find('textarea').attr("disabled", true);
        self.el.searchBoxReviewer.attr("disabled", true);
        self.el.testPoForm.find('a[type="button"]').not("#submitButton").hide();
        self.el.testPoForm.find('button[type="button"]').not(".next-button").hide();
        self.el.submitButton.parent().html(self.el.gobackButton);
        self.el.testPoForm.attr("href", "#");
    },
    destroy: function () {
    }
});
