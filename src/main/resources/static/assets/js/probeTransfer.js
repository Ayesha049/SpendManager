$.widget("forecast.probeTransfer", {
    options: {
        messages: undefined
    },
    _create: function () {
        console.log("SMNLOG :: ---------- PROBE Transfer widget create ----------");
        var self = this;
        self.el = {};
        self.data = {};

        // UI element Initialization
        self.el.probeTransferForm = $("#transferForm");
        ...
        self.el.workOrderSelect.change(function () {
            ...
            console.log("select probeWorkOrderId :::: " + probeWorkOrderId);
            self.makeWipTransferDetailsTable(probeWorkOrderId);
        });
    ...
    _init: function () {
        console.log("SMNLOG :: ---------- PROBE WIP Transfer init ----------");
        var self = this;

    },
    makeWipTransferDetailsTable: function (probeWorkOrderId) {
        var self = this;
        var listSize = 0;
        ...
        if (probeWorkOrderId > 0) {
            ...
            $.get('/admin/getProbeWipInventoryForTransfer', {probeWorkOrderId: probeWorkOrderId}, function (list) {
                ...
                self.generateTransferStatusTable(probeWorkOrderId, listSize);
    ...
    generateTransferStatusTable: function(probeWorkOrderId, transferTableDetailsSize){
        var self=this;
        var html = '<table class="table table-striped custom-table">';
        html += '<thead>';
        ...
        $.get('/admin/getProbeWipInventoryStatusForTransfer', {probeWorkOrderId: probeWorkOrderId}, function (list) {
    ...
    changeStatusTransferProductItemBtnEvent: function(trObject, status){
        ...
        var validator = self.el.probeTransferForm.validate();
        var errorMessage = "";
    ...
    recordStatusChange:function(trObject, productItemId, productTransferItemId, status, transferredQuantity, wasteQuantity){
        ...
        $.get('/admin/transferProbeServiceChangeProductTransferItemStatus',
            {
            ...
            function(response){
                ...
                self.el.probeTransferForm.validate();
    ...
    transferProductItem: function(trObject, productItemId, transferQty){
        ...
        $.get('/admin/transferProbeService',
            {
                productItemId: productItemId,
    ...
    initiateFormValidation: function (transferTableDetailsSize, transferStatusTableSize) {
        ...
        self.el.probeTransferForm.validate(validateJson);
    },
